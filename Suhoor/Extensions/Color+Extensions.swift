...
extension Color {
    ...
    /// Night mode background — deeper, cooler tone for post-iftar
    static let suhoorNight = Color(red: 0.05, green: 0.05, blue: 0.15)
    ...
    /// Cool moonlight blue for night mode accents
    static let suhoorMoonlight = Color(red: 0.55, green: 0.70, blue: 0.90)
